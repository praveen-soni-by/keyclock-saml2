...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean , EnvironmentAware {
    ...
    public KeyManager keyManager() {
        ...
        Resource storeFile = loader
                .getResource(environment.getRequiredProperty("saml.cert.path"));
        String storePass = environment.getRequiredProperty("saml.storePass");
        String alias = environment.getRequiredProperty("saml.alias");
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityId(environment.getRequiredProperty("keycloak.client_id"));
    ...
    public SavedRequestAwareAuthenticationSuccessHandler successRedirectHandler() {
        ...
        successRedirectHandler.setDefaultTargetUrl(environment.getRequiredProperty("keycloak.targetUrl"));
    ...
    public SimpleUrlAuthenticationFailureHandler authenticationFailureHandler() {
	    	...
	    	failureHandler.setDefaultFailureUrl(environment.getRequiredProperty("keycloak.errorUrl"));
